...
def app():
    ...
    data_cities = pd.read_csv("data/transport/cities.csv")
    data_providers = pd.read_csv('data/transport/providers.csv')
    data_stations = pd.read_csv("data/transport/stations.csv")
    data_ticket = pd.read_csv('data/transport/ticket_data.csv')
